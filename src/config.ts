  ...
  search: z
    .object({
      ...
      rerank: z
        ...
        .prefault({}),
      // Код из истории git (§21). Он отвечает на «а где это было раньше», но
      // конкурирует с актуальным кодом, будучи на него похожим, поэтому в норме
      // должен уступать ему место.
